...
_STATE.fields_by_name['plane']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_POLICY.fields_by_name['index'].has_options = True
_POLICY.fields_by_name['index']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_POLICY.fields_by_name['prior'].has_options = True
_POLICY.fields_by_name['prior']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_GAME.fields_by_name['value'].has_options = True
_GAME.fields_by_name['value']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_GAME.fields_by_name['move'].has_options = True
_GAME.fields_by_name['move']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
