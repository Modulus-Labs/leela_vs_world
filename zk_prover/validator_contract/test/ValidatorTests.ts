...
import { Validator__factory } from '../typechain-types/factories/Validator__factory';
...
describe("VerifierExample", function () {
  ...
  describe("Validation", function () {
    it("Should validate a proof", async function () {
      ...
      var input_json = JSON.parse(fs.readFileSync("../bgnet_intermediates_new.json").toString());
