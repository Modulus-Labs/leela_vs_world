    ...
    <div>
      ...
      >
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          <span style={{ fontSize: 15, fontWeight: "bolder", textDecorationLine: "underline" }}>
            {"Acknowledgements"}
          </span>
          ...
          <span style={{ marginBottom: 20, fontSize: 15 }}>
            ...
            <a href={"https://github.com/Modulus-Labs/leela_vs_world"} target={"_blank"} style={{ textDecorationLine: "underline" }}>
              {"GitHub"}
            </a>
          </span>
          ...
          <span style={{ fontSize: 15 }}>
            {"- And for the "}
            <a href={"https://audius.co/ModulusLabs/leela-ascends"} target={"_blank"}>
              <span style={{ textDecorationLine: "underline" }}>
          ...
          <span style={{ fontSize: 15 }}>
            ...
            <a href={"https://github.com/privacy-scaling-explorations/halo2"} target={"_blank"} style={{ textDecorationLine: "underline" }}>
              {"GitHub"}
            </a>
          </span>
          ...
          <span style={{ fontSize: 15 }}>
            ...
            <a href={"https://github.com/axiom-crypto/snark-verifier"} target={"_blank"} style={{ textDecorationLine: "underline" }}>
              {"GitHub"}
            </a>
          </span>
          ...
          <span style={{ marginBottom: 20, fontSize: 15 }}>
            ...
            <a href={"https://github.com/dkappe/badgyal"} target={"_blank"} style={{ textDecorationLine: "underline" }}>
              {"GitHub"}
            </a>
          </span>

          <button
            style={{ backgroundColor: "transparent", borderRadius: 10, borderColor: "black", paddingTop: 5, paddingBottom: 5, paddingLeft: 10, paddingRight: 10, fontSize: 15, borderWidth: 1, alignSelf: "center" }}
            onClick={() => { setShowModulusAndFriendsModal(false) }}>{"Cool beans!"}</button>
        </div >
      </Modal >
    </div >
  );
